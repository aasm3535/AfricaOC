 ...
 * @param ptr Указатель на блок для изменения размера.
 * @param new_size Новый размер блока в байтах.
 * @return Указатель на новый блок памяти или 0 в случае ошибки.
 */
void* realloc(void* ptr, size_t new_size); // <<<--- ДОБАВИТЬ
